...
const CartWidget = (props) => {
    ...
    <>
        <div className='nav__link flex flex-col items-baseline my-auto'>
            <Link to='/cart' activeClassName='active'><FontAwesomeIcon className="nav__cart text-neutral-100 text-2xl px-4 py-2 rounded-lg ml-2" style = {{cursor:"pointer"}} icon={faCartShopping} /></Link>
        </div>
